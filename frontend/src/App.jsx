...
function App() {
  ...
  const data = [
    ...
    { id: 2, name: "Lee", level: "Intermediate", description: "Đang học nâng cao" },
  ...
  return (
    <div className="p-8 space-y-6 min-h-screen">
      <h1 className="text-2xl font-bold mb-4">Quản lý trung tâm tiếng Hàn</h1>
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)} title="Modal demo">
        <p className="pb-6">Đây là nội dung modal. Bạn có thể đặt form hoặc thông tin tại đây.</p>
